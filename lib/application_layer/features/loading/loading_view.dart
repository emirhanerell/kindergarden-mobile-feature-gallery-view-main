import 'package:kindergarden_mobile/application_layer/components/animation/spin_animation.dart';
                          ...
                          ? Container(
                              ...
                              child: Center(
                                child: Row(
                                  ...
                                  children: [
                                    SpinAnimation(
                                        child: Image.asset(ImagePathEnums.iconWhite.path,
                                            height: StateManagement.include.message != "" ? context.height * 0.05 : context.height * 0.07)),
